...
namespace
{
    ...
    struct OpenHarmonyStackTrace
    {
        ...
        static _Unwind_Reason_Code Callback(struct _Unwind_Context* context, void* self)
        {
            ...
            if (static_cast<OpenHarmonyStackTrace*>(self)->PushStackFrameAddress(addr))
    ...
    {
        OpenHarmonyStackTrace callstack = {};
        _Unwind_Backtrace(OpenHarmonyStackTrace::Callback, &callstack);
